  ...
  return (
    <div className="relative" id="input">
      <input
        // value={true}
        placeholder="Search..."
        className="block w-[600px] text-lg h-[50px] px-6 text-slate-900 bg-white rounded-[16px] border border-slate-200 appearance-none focus:border-transparent focus:outline focus:outline-2 focus:outline-primary focus:ring-0 hover:border-brand-500-secondary- peer invalid:border-error-500 invalid:focus:border-error-500 overflow-ellipsis overflow-hidden text-nowrap pr-[48px] placeholder:text-lg"
